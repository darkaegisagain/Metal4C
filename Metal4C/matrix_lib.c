...
//  Metal4C
//
//  Hacked up by Michael Larson on 2/28/26.
//
...
void vec3_str(vec3_t vec, char *buffer, size_t len)
{
    snprintf(buffer, len, "[%f, %f, %f]", vec[0], vec[1], vec[2]);
}

void mat3_str(mat3_t mat, char *buffer, size_t len)
{
    snprintf(buffer, len, "[%f, %f, %f, %f, %f, %f, %f, %f, %f]", mat[0], mat[1], mat[2], mat[3], mat[4], mat[5], mat[6], mat[7], mat[8]);
}

void mat4_str(mat4_t mat, char *buffer, size_t len)
{
    snprintf(buffer, len, "[%f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f]",
...
void quat_str(quat_t quat, char *buffer, size_t len)
{
    snprintf(buffer, len, "[%f, %f, %f, %f]", quat[0], quat[1], quat[2], quat[3]);
}
