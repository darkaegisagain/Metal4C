...
matrix_float3x3 MTL_SIMD_OVERLOAD matrix_make_rows(float m00, float m10, float m20,
...
matrix_float4x4 MTL_SIMD_OVERLOAD matrix_make_rows(float m00, float m10, float m20, float m30,
                                                    float m01, float m11, float m21, float m31,
                                                    float m02, float m12, float m22, float m32,
                                                    float m03, float m13, float m23, float m33);

/// Constructs a 3x3 matrix from three 3D vectors.
matrix_float3x3 MTL_SIMD_OVERLOAD matrix_make_columns(vector_float3 col0,
                                                       vector_float3 col1,
                                                       vector_float3 col2);

/// Constructs a 4x4 matrix from four 4D vectors.
matrix_float4x4 MTL_SIMD_OVERLOAD matrix_make_columns(vector_float4 col0,
                                                       vector_float4 col1,
                                                       vector_float4 col2,
                                                       vector_float4 col3);
...
matrix_float4x4 MTL_SIMD_OVERLOAD matrix_perspective_frustum_right_hand(float left, float right, float bottom, float top, float nearZ, float farZ);
